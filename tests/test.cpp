...
//
//	//! ---|> [Object]
//	virtual bool getAttribute(const identifierId id,Attribute & attr){
//		if(id==ID_m1){
//			attr.set(new NumberRef(ref().m1),0);
//			return true;
//		}else if(id==ID_m2){
//			attr.set(new NumberRef(ref().m2),0);
//			return true;
//		}else{
//			return Object::getAttribute(id,attr);
//		}
//	}
//
//	//! ---|> [Object]
