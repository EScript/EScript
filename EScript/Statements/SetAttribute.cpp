...
//! (ctor)
SetAttribute::SetAttribute(Object * obj,identifierId _attrId,Object * valueExp,assignType_t _assignType,int _line):
		objRef(obj),valueExpRef(valueExp),attrId(_attrId),assignType(_assignType),line(_line) {
	//ctor
}
