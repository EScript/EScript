...
class Runtime : public ExtObject  {
    ...
    public:
        ...
        void initVariable(const identifierId id,Object * value);
        void initVariable(const std::string & name,Object * value) {
            initVariable(EScript::stringToIdentifierId(name),value);
        }
	public:
	...
	private:
        Object * executeUserFunction(RuntimeBlock * rtb,const ObjPtr & _callingObject,bool lambda);
    ...
    public:
		enum state_t{
			STATE_NORMAL,STATE_BREAK,STATE_CONTINUE,STATE_RETURN,STATE_EXIT,STATE_EXCEPTION
		};

        inline bool checkNormalState()const 			{	return state==STATE_NORMAL;	}
    ...
    public:
        ...
        inline int getCurrentLine()const	{	return currentLine;	}
        inline void setCurrentLine(int l)	{	currentLine=l;	}
